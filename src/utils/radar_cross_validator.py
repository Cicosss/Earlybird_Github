...
class PendingAlert:
    ...
    def _recalculate_confidence(self, new_confidence: float) -> None:
        ...
        self.boosted_confidence = min(self.original_confidence + boost, MAX_CONFIDENCE)
...
class CrossSourceValidator:
    ...
    def register_alert(
        self, team: str, category: str, source_name: str, source_url: str, confidence: float
    ...
    def check_existing(self, team: str, category: str) -> PendingAlert | None:
        """
    ...
    def should_wait_for_confirmation(
        self, team: str, category: str, min_wait_seconds: int = 30
    ) -> bool:
        """
...
# Singleton instance
_validator: CrossSourceValidator | None = None

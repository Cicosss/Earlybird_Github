...
def get_odds_history(match_id: str, hours_back: int = 24) -> list[OddsSnapshot]:
    ...
    try:
        ...
        snapshots = (
            ...
            .filter(OddsSnapshot.match_id == match_id, OddsSnapshot.timestamp >= cutoff_naive)
...
def _estimate_rlm_time_window(match_id: str | None) -> int:
    """
...
def detect_reverse_line_movement(
    match: Match, public_bet_distribution: dict[str, float] | None = None
) -> ReverseLineSignal | None:
    """
...
def detect_rlm_v2(
    match: Match,
    public_bet_distribution: dict[str, float] | None = None,
    ...
    if public_home >= min_public_threshold and home_movement_pct >= min_odds_increase_pct:
        ...
        signal = RLMSignalV2(
            ...
            recommendation="Consider AWAY (sharp money detected)",
        ...
        signal = RLMSignalV2(
            ...
            confidence=confidence,
            time_window_min=time_window_min,
            recommendation="Consider HOME (sharp money detected)",
            high_potential=high_potential,
...
def calculate_news_freshness_multiplier(
    news_date_str: str | None, reference_time: datetime | None = None, league_key: str = None
) -> tuple[float, int]:
    """
...
def save_odds_snapshot(
    ...
    draw_odd: float | None,
    away_odd: float | None,
    sharp_home_odd: float | None = None,
    sharp_draw_odd: float | None = None,
    sharp_away_odd: float | None = None,
    sharp_bookie: str | None = None,
) -> bool:
    """
...
def analyze_market_intelligence(
    match: Match, public_bet_distribution: dict[str, float] | None = None, league_key: str = None
) -> MarketIntelligence:
    """

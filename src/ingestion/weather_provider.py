...
def get_weather_forecast(lat: float, lon: float, match_time: datetime) -> dict | None:
    """
...
def analyze_weather_impact(weather_data: dict) -> dict | None:
    """
    ...
    result = {
        ...
        "raw": {"snow_cm": snow, "rain_mm": rain, "wind_kmh": wind, "temp_c": temp},
    }
...
def get_match_weather(lat: float, lon: float, match_time: datetime) -> dict | None:
    """

...
class TestNewsHunterSafeGetFixes:
    ...
    def test_item_fallback_snippet(self):
        ...
        item = {"description": "Description text", "channel": "test_channel"}

        # Test snippet fallback
        snippet = safe_dict_get(item, "snippet", default="") or safe_dict_get(
    ...
    def test_item_source_type_fallback(self):
        ...
        item = {"search_type": "mainstream", "channel": "test_channel"}
    ...
    def test_item_link_lower(self):
        ...
        item = {"link": "HTTPS://EXAMPLE.COM/NEWS", "channel": "test_channel"}
...
class TestBotIntelligentCommunication:
    ...
    def test_telegram_listener_to_squad_analyzer(self):
        ...
        full_text = safe_dict_get(squad_data, "full_text", default="") or safe_dict_get(
            squad_data, "caption", default=""
        )

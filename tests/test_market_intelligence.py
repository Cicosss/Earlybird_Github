...
class TestReverseLineMovement:
    ...
    def test_rlm_requires_threshold_public(self):
        ...
        match = self.create_mock_match(
            opening_home=1.80, current_home=1.90, opening_away=2.20, current_away=2.10
        )
    ...
    def test_rlm_missing_odds_returns_none(self):
        ...
        match = self.create_mock_match(
            opening_home=None, current_home=1.90, opening_away=2.20, current_away=2.10
        )
    ...
    def test_rlm_estimates_public_when_not_provided(self):
        ...
        match = self.create_mock_match(
            opening_home=1.50,
            current_home=1.60,  # Rising despite being favorite
            opening_away=3.00,
            current_away=2.80,
        )

...
class TestFix2PartialDataFallback:
    ...
    def test_fallback_triggered_for_partial_data(self):
        ...
        deepseek_result = {
            "accounts": [{"handle": "@handle1", "posts": []}, {"handle": "@handle2", "posts": []}]
        }
        ...
        missing_handles = [
            h for h in all_handles if h.lower().replace("@", "") not in returned_handles
        ]
...
class TestFix3HandleValidation:
    ...
    def test_get_all_twitter_handles_filters_none(self):
        ...
        for handle in handles:
            ...
            assert handle.strip(), "FIX 3: Empty handle found!"
...
class TestIntegrationTwitterIntelFlow:
    ...
    def test_full_flow_with_mocked_providers(self):
        ...
        """
        from config.twitter_intel_accounts import find_account_by_handle, get_all_twitter_handles

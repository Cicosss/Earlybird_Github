...
class LogCapture:
    ...
    def contains(self, substring: str, level: str | None = None) -> bool:
        """
    ...
    def contains_pattern(self, pattern: str, level: str | None = None) -> bool:
        """
    ...
    def assert_logged(self, substring: str, level: str | None = None, msg: str = "") -> None:
        """
    ...
    def assert_not_logged(self, substring: str, level: str | None = None, msg: str = "") -> None:
...
def mock_news_items(mock_news_item) -> list[dict[str, Any]]:
    ...
    item2["team"] = "AC Milan"
    item2["snippet"] = (
        "Rafael Leao has recovered from his knock and will be available for the derby."
    )
...
def mock_tavily_provider():
    ...
    class MockTavilyProvider:
        ...
        def search(self, query: str, **kwargs) -> dict | None:
            self._call_count += 1
...
def mock_perplexity_provider():
    ...
    class MockPerplexityProvider:
        ...
        def query(self, prompt: str, **kwargs) -> dict | None:
            self._call_count += 1
            if self._should_fail:
                return None
            return self._response

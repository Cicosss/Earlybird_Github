...
class TestShrinkageKelly:
    ...
    def test_shrinkage_converges_large_sample(self):
        ...
        edge_standard = MathPredictor.calculate_edge(
            0.60, 1.80, sample_size=100, use_shrinkage=False
        )
...
class TestEndToEndFlow:
    ...
    def test_optimizer_records_sortino(self):
        ...
        try:
            ...
            assert (
                stats["sortino"] != 0.0 or stats["bets"] < 10
            )  # Either calculated or not enough data

...
from src.analysis.math_engine import EdgeResult, MathPredictor
...
class TestKellyEdgeE2EIntegration:
    ...
    def test_notifier_formats_correctly_with_valid_math_edge(self):
        ...
        """
        math_edge = {"market": "HOME", "edge": 7.6, "kelly_stake": 2.66}
    ...
    def test_html_safety_with_market_names(self):
        ...
        for market in valid_markets:
            math_edge = {"market": market, "edge": 7.0, "kelly_stake": 2.0}

...
class TestCrossContractValidation:
    ...
    def test_full_pipeline_contracts(self, valid_news_item, mock_match):
        ...
        assert ANALYSIS_RESULT_CONTRACT.validate(analysis_result)[0], (
            "ANALYSIS_RESULT_CONTRACT fallito"
        )
        ...
        assert VERIFICATION_RESULT_CONTRACT.validate(verification_result)[0], (
            "VERIFICATION_RESULT_CONTRACT fallito"
        )

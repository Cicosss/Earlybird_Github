...
class TestGhostMatchPrevention:
    ...
    def test_ingestion_skips_past_matches(self):
        ...
        assert should_skip == True, "GHOST MATCH BUG: Ingestion dovrebbe skippare partite passate!"
...
class TestDateInjection:
    ...
    def test_deep_dive_prompt_includes_today_iso(self):
        ...
        prompt = build_deep_dive_prompt(
            home_team="Inter", away_team="Milan", match_date="2025-12-28", referee="Referee Name"
        )
        ...
        assert re.search(iso_pattern, prompt), (
            "DATE FORMAT BUG: Data deve essere in formato ISO 8601 (YYYY-MM-DD)"
        )
...
class TestSearchProviderFreshness:
    ...
    def test_ddg_timelimit_parameter_exists(self):
        ...
        try:
            ...
            with open("src/ingestion/search_provider.py") as f:
                content = f.read()
    ...
    def test_brave_freshness_parameter_exists(self):
        ...
        try:
            ...
            with open("src/ingestion/brave_provider.py") as f:
                content = f.read()
...
class TestContextCachingOptimization:
    ...
    def _read_analyzer_source(self):
        ...
        with open("src/analysis/analyzer.py") as f:
            return f.read()
...
class TestTelegramSpyIntelInjection:
    ...
    def test_telegram_intel_query_exists(self):
        ...
        assert (
            "get_social_sources_with_fallback" in source
            or "get_news_sources_with_fallback" in source
    ...
    @pytest.mark.skip(
        reason="V9.5 REFACTOR: Telegram Intel has been refactored to use Supabase provider instead of direct DB queries. Tests for telegram_ocr, telegram_channel, SPY INTEL are no longer applicable."
    )
    ...
    def test_telegram_intel_appended_to_news_dossier(self):
        ...
        assert (
            "news_dossier + spy_text" in source
            or "news_dossier = news_dossier + spy_text" in source
            or "radar_news_snippet + spy_text" in source

...
class TestTwitterIntelAccounts:
    ...
    def test_get_handles_by_tier_elite_7(self):
        ...
        from config.twitter_intel_accounts import LeagueTier, get_handles_by_tier
...
class TestTwitterIntelCache:
    ...
    def test_find_account_info_global(self):
        ...
        assert (
            "global" in account_info.focus.lower()
            or "international" in account_info.focus.lower()
            or "african" in account_info.focus.lower()
        )
    ...
    def test_search_intel_case_insensitive(self):
        ...
        cache._cache["@test"] = TwitterIntelCacheEntry(
            ...
            tweets=[
                CachedTweet(
                    handle="@test", date="2026-01-01", content="GALATASARAY news here", topics=[]
                )
            ],
            last_refresh=datetime.now(),
            extraction_success=True,
    ...
    def test_search_intel_with_topics_filter(self):
        ...
        cache._cache["@test"] = TwitterIntelCacheEntry(
            ...
            tweets=[
                CachedTweet(
                    handle="@test", date="2026-01-01", content="Team injury news", topics=["injury"]
                ),
                CachedTweet(
                    handle="@test",
                    date="2026-01-01",
    ...
    def test_clear_cache(self):
        ...
        from src.services.twitter_intel_cache import TwitterIntelCache, TwitterIntelCacheEntry
...
class TestTwitterIntelIntegration:
    ...
    def test_search_intel_with_none_topics(self):
        ...
        cache._cache["@test"] = TwitterIntelCacheEntry(
            ...
            tweets=[
                CachedTweet(
                    handle="@test", date="2026-01-01", content="Test content here", topics=[]
                )
            ],
            last_refresh=datetime.now(),
            extraction_success=True,
    ...
    def test_search_intel_with_empty_topics_list(self):
        ...
        cache._cache["@test"] = TwitterIntelCacheEntry(
            ...
            tweets=[
                CachedTweet(
                    handle="@test", date="2026-01-01", content="Test content", topics=["injury"]
                )
            ],
            last_refresh=datetime.now(),
            extraction_success=True,

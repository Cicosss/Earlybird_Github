...
class TestE2EIntelligenceRouterFlow:
    ...
    def test_router_deep_dive_returns_normalized_dict(self):
        ...
        with patch.dict(os.environ, {"OPENROUTER_API_KEY": "test-key"}):
            ...
            with patch.object(
                router._primary_provider, "get_match_deep_dive", return_value=mock_deepseek_response
            ):
                result = router.get_match_deep_dive(
                    home_team="Inter", away_team="Milan", match_date="2026-01-15"
                )
...
class TestE2ERateLimiting:
    ...
    def test_rate_limiting_enforces_minimum_interval(self):
        ...
        from src.ingestion.deepseek_intel_provider import (
            DEEPSEEK_MIN_INTERVAL,

...
class TestParallelEnrichment:
    ...
    def test_enrichment_result_with_injuries(self):
        ...
        result = EnrichmentResult(home_context={"injuries": [{"name": "Player1"}]}, away_context={})
    ...
    def test_enrichment_result_with_high_turnover(self):
        ...
        result2 = EnrichmentResult(home_turnover={"risk_level": "MEDIUM"})
        assert result2.has_high_turnover() == False

        # High turnover (should trigger)
        result3 = EnrichmentResult(away_turnover={"risk_level": "HIGH"})
...
class TestDynamicThreshold:
    ...
    def test_dynamic_threshold_base_case(self):
        ...
        from src.analysis.optimizer import ALERT_THRESHOLD_BASE, get_dynamic_alert_threshold
...
class TestHighPriorityCallback:
    ...
    def test_callback_registration(self):
        ...
        queue.register_high_priority_callback(
            callback=test_callback, threshold=0.8, categories=["INJURY"]
        )
    ...
    def test_callback_triggered_on_high_priority(self):
        ...
        queue.register_high_priority_callback(
            callback=test_callback, threshold=0.8, categories=["INJURY", "SUSPENSION"]
        )
    ...
    def test_callback_exception_handling(self):
        ...
        queue.register_high_priority_callback(
            callback=failing_callback, threshold=0.8, categories=["INJURY"]
        )
...
class TestIntegration:
    ...
    def test_full_flow_mock(self):
        ...
        queue.register_high_priority_callback(
            callback=on_high_priority, threshold=0.85, categories=["INJURY", "SUSPENSION", "LINEUP"]
        )

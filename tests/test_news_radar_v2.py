...
class TestHighValueSignalDetector:
    ...
    def test_threshold_not_met(self):
        ...
        assert (
            signal.detected is False
            or signal.extracted_number is None
            or signal.extracted_number < 3
        )
...
class TestBackwardCompatibility:
    ...
    def test_parse_response_v1_format_team_mapping(self):
        ...
        assert result.affected_team == "Inter", (
            "V1 'affected_team' should map to result.affected_team"
        )
    ...
    def test_parse_response_v2_takes_precedence(self):
        ...
        assert result is not None
        assert result.affected_team == "Roma", (
            "V2 'team' should take precedence over V1 'affected_team'"
        )
        assert result.summary == "Primavera in campo", (
            "V2 'summary_italian' should take precedence over V1 'summary'"
        )

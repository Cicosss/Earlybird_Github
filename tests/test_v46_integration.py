...
class TestMathEngineIntegration:
    ...
    def test_kelly_stake_reasonable_for_small_samples(self):
        ...
        assert edge.kelly_stake <= 5.0, f"Kelly stake {edge.kelly_stake}% exceeds cap"
...
class TestFatigueEngineIntegration:
    ...
    def test_get_enhanced_fatigue_context_with_fotmob_data(self):
        ...
        assert differential.differential > 0, "Home should be more fatigued (positive differential)"
    ...
    def test_fatigue_with_none_hours(self):
        ...
        home_context = {
            "fatigue": {"hours_since_last": None, "fatigue_level": "FRESH - Season start"}
        }

        away_context = {"fatigue": {"hours_since_last": 96.0, "fatigue_level": "LOW"}}
...
class TestWeatherProviderIntegration:
    ...
    def test_analyze_weather_returns_correct_format(self):
        ...
        weather_data = {"wind_kmh": 45, "precipitation_mm": 6, "snowfall_cm": 0, "temperature_c": 8}
...
class TestInjuryImpactIntegration:
    ...
    def test_analyze_match_injuries_with_snippet_data_format(self):
        ...
        away_context = {"injuries": [{"name": "Backup Player", "reason": "Illness"}], "squad": None}
...
class TestEndToEndDataFlow:
    ...
    def test_all_engines_handle_none_gracefully(self):
        ...
        from src.analysis.injury_impact_engine import estimate_player_role
        from src.analysis.math_engine import calculate_btts_trend
        from src.ingestion.weather_provider import analyze_weather_impact, validate_coordinates

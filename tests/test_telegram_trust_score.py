...
class TestEchoChamber:
    ...
    def test_unique_message_not_echo(self):
        ...
        is_echo, source = check_echo_chamber(
            "channel_a", "Unique message about Galatasaray lineup", datetime.now(timezone.utc)
        )
    ...
    def test_same_channel_not_echo(self):
        ...
        is_echo, source = check_echo_chamber(
            "channel_a", "Test message content", now + timedelta(seconds=30)
        )
...
class TestTrustScoreCalculation:
    ...
    def test_zero_messages_no_crash(self):
        ...
        metrics = ChannelMetrics(channel_id="test", channel_name="test", total_messages=0)
...
class TestTrackOddsCorrelation:
    ...
    def test_track_odds_correlation_missing_channel_id(self):
        ...
        result = track_odds_correlation(
            channel_id=None, message_time=datetime.now(timezone.utc), match_id="test_match"
        )
    ...
    def test_track_odds_correlation_missing_match_id(self):
        ...
        result = track_odds_correlation(
            channel_id="test_channel", message_time=datetime.now(timezone.utc), match_id=None
        )
        assert result is None
    ...
    def test_track_odds_correlation_missing_message_time(self):
        ...
        result = track_odds_correlation(
            channel_id="test_channel", message_time=None, match_id="test_match"
        )
        assert result is None
    ...
    def test_track_odds_correlation_empty_channel_id(self):
        ...
        result = track_odds_correlation(
            channel_id="", message_time=datetime.now(timezone.utc), match_id="test_match"
        )
        assert result is None
    ...
    def test_track_odds_correlation_empty_match_id(self):
        ...
        result = track_odds_correlation(
            channel_id="test_channel", message_time=datetime.now(timezone.utc), match_id=""
        )
        assert result is None
...
class TestTrustLevelEnumSafeParsing:
    ...
    def test_invalid_trust_level_returns_neutral(self):
        ...
        from src.analysis.telegram_trust_score import TrustLevel, get_channel_trust_metrics
        ...
        with patch(
            "src.database.telegram_channel_model.get_channel_metrics", return_value=mock_metrics
        ):

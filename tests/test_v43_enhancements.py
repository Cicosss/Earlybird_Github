...
class TestHomeAdvantageByLeague:
    ...
    def test_get_home_advantage_default(self):
        ...
        from config.settings import DEFAULT_HOME_ADVANTAGE, get_home_advantage
    ...
    def test_simulate_match_applies_home_advantage(self):
        ...
        stats = {"home_scored": 1.5, "home_conceded": 1.0, "away_scored": 1.2, "away_conceded": 1.3}
...
class TestLeagueAdaptiveNewsDecay:
    ...
    def test_apply_news_decay_uniform(self):
        ...
        decayed_argentina = apply_news_decay(
            impact, minutes, league_key="soccer_argentina_primera_division"
        )
    ...
    def test_optimizer_records_sortino(self):
        ...
        try:
            ...
            optimizer.record_bet_result(
                "soccer_turkey_super_league", "Over 2.5", "WIN", 1.9, "MATH_VALUE"
            )
            optimizer.record_bet_result(
                "soccer_turkey_super_league", "Over 2.5", "WIN", 1.85, "MATH_VALUE"
            )
            optimizer.record_bet_result(
                "soccer_turkey_super_league", "Over 2.5", "LOSS", 1.9, "MATH_VALUE"
            )
...
class TestNewsHunterIntegration:
    ...
    def test_calculate_news_freshness_uniform(self):
        ...
        mult_turkey, mins1 = calculate_news_freshness_multiplier(
            news_date, league_key="soccer_turkey_super_league"
        )

        mult_argentina, mins2 = calculate_news_freshness_multiplier(
            news_date, league_key="soccer_argentina_primera_division"
        )
...
class TestSteamMoveTierBasedWindows:
    ...
    def test_get_steam_window_uniform_for_all_leagues(self):
        ...
        from src.analysis.market_intelligence import (
            STEAM_MOVE_TIME_WINDOW_MIN,
            get_steam_window_for_league,
        )
    ...
    def test_detect_steam_move_accepts_league_key(self):
        ...
        result = detect_steam_move(
            "match123", {"home": 1.85}, league_key="soccer_turkey_super_league"
        )
...
class TestBiscottoMinorLeagueThresholds:
    ...
    def test_get_enhanced_biscotto_extracts_matches_remaining(self):
        ...
        analysis, context_str = get_enhanced_biscotto_analysis(
            match_obj=mock_match, home_motivation=home_motivation, away_motivation=away_motivation
        )
...
class TestFatigueLowTierTeams:
    ...
    def test_get_squad_depth_low_tier_teams(self):
        ...
        from src.analysis.fatigue_engine import SQUAD_DEPTH_LOW, get_squad_depth_score
    ...
    def test_get_squad_depth_elite_teams(self):
        ...
        from src.analysis.fatigue_engine import SQUAD_DEPTH_ELITE, get_squad_depth_score
    ...
    def test_get_squad_depth_mid_tier_teams(self):
        ...
        from src.analysis.fatigue_engine import SQUAD_DEPTH_MID, get_squad_depth_score

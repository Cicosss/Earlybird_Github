...
class TestALeagueArticleFiltering:
    ...
    def test_ins_outs_detection(self):
        ...
        # URL-based detection
        assert (
            _is_ins_outs_article(
                "https://aleagues.com.au/news/ins-outs-team-news-round-10/", "Team News Round 10"
            )
            == True
        )
        ...
        assert (
            _is_ins_outs_article(
                "https://aleagues.com.au/news/some-article/", "Ins and Outs: Round 10 Team News"
            )
            == True
        )
        ...
        assert (
            _is_ins_outs_article(
                "https://aleagues.com.au/news/injury-update-sydney-fc/", "Sydney FC Injury Update"
            )
            == True
        )
    ...
    def test_regular_news_not_ins_outs(self):
        ...
        assert (
            _is_ins_outs_article(
                "https://aleagues.com.au/news/transfer-news/", "New Signing Announced"
            )
            == False
        )

        assert (
            _is_ins_outs_article("https://aleagues.com.au/news/match-report/", "Sydney FC wins 2-1")
            == False
        )
...
class TestALeagueRateLimiting:
    ...
    def test_should_scrape_first_time(self):
        ...
        from src.ingestion.aleague_scraper import _should_scrape
    ...
    def test_should_not_scrape_immediately_after(self):
        ...
        from src.ingestion.aleague_scraper import _mark_scraped, _should_scrape
    ...
    def test_should_scrape_after_interval(self):
        ...
        import src.ingestion.aleague_scraper as scraper_module
        from src.ingestion.aleague_scraper import SCRAPE_INTERVAL_MINUTES, _should_scrape

        # Set last scrape to past the interval
        scraper_module._last_scrape_time = datetime.now() - timedelta(
            minutes=SCRAPE_INTERVAL_MINUTES + 1
        )
...
class TestSourcesConfigTelegramGlobal:
    ...
    def test_global_channels_added_to_all_countries(self):
        ...
        from src.processing.sources_config import TELEGRAM_INSIDERS, get_all_telegram_channels
    ...
    def test_get_telegram_channels_includes_global(self):
        ...
        from src.processing.sources_config import TELEGRAM_INSIDERS, get_telegram_channels

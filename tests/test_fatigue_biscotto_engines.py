...
class TestFatigueEngine:
    ...
    def test_analyze_team_fatigue_none_hours(self):
        ...
        result = analyze_team_fatigue(team_name="Test FC", hours_since_last=None)
...
class TestBiscottoEngine:
    ...
    def test_zscore_normal(self):
        ...
        from src.analysis.biscotto_engine import LEAGUE_AVG_DRAW_PROB, calculate_zscore
    ...
    def test_analyze_biscotto_none_odds(self):
        ...
        result = analyze_biscotto(home_team="Home FC", away_team="Away FC", current_draw_odd=None)
    ...
    def test_analyze_biscotto_with_motivation(self):
        ...
        home_motivation = {"position": 18, "total_teams": 20, "points": 25, "zone": "Relegation"}
        away_motivation = {"position": 17, "total_teams": 20, "points": 26, "zone": "Danger Zone"}
...
class TestIntegration:
    ...
    def test_fatigue_context_helper(self):
        ...
        home_context = {"fatigue": {"hours_since_last": 72}}
        away_context = {"fatigue": {"hours_since_last": 120}}
    ...
    def test_fatigue_context_empty_context(self):
        ...
        differential, context_str = get_enhanced_fatigue_context(
            home_team="Home FC", away_team="Away FC", home_context={}, away_context={}
        )
    ...
    def test_biscotto_with_empty_motivation_no_crash(self):
        ...
        analysis, context_str = get_enhanced_biscotto_analysis(
            match_obj=match, home_motivation=home_motivation, away_motivation=away_motivation
        )

        # Verify it returns valid results
        assert analysis is not None
        assert analysis.severity in [
            BiscottoSeverity.NONE,
            BiscottoSeverity.LOW,
            BiscottoSeverity.MEDIUM,
            BiscottoSeverity.HIGH,
            BiscottoSeverity.EXTREME,
        ]

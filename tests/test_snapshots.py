...
def assert_snapshot_match(
    name: str, actual: dict[str, Any], update: bool = False, ignore_keys: list = None
) -> None:
    """
...
class TestAnalyzerSnapshots:
    ...
    def test_bet_analysis_snapshot(self, standard_analysis_input):
        ...
        assert_snapshot_match(
            "analyzer_bet_output", bet_analysis, ignore_keys=["reasoning", "combo_reasoning"]
        )
    ...
    def test_no_bet_analysis_snapshot(self):
        ...
        assert_snapshot_match(
            "analyzer_no_bet_output", no_bet_analysis, ignore_keys=["reasoning", "combo_reasoning"]
        )
...
class TestAlertPayloadSnapshots:
    ...
    def test_telegram_alert_structure_snapshot(self):
        ...
        alert_structure = {
            "required_fields": sorted(["match_obj", "news_summary", "news_url", "score", "league"]),
    ...
    def test_validator_functions_exist(self):
        ...
        validators_snapshot = {
            "available_validators": sorted(
                [name for name in expected_validators if hasattr(validators, name)]
            ),
        }

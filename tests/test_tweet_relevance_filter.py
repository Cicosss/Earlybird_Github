...
class TestTeamMatching:
    ...
    def test_exact_team_match(self):
        ...
        matched, confidence = match_team_in_text(
            "Galatasaray injury update: Icardi out for 2 weeks", "Galatasaray"
        )
    ...
    def test_alias_match_gala(self):
        ...
        matched, confidence = match_team_in_text("Gala vs Fener derby preview", "Galatasaray")
    ...
    def test_alias_match_boca(self):
        ...
        matched, confidence = match_team_in_text("CABJ lineup confirmed for Copa", "Boca Juniors")
    ...
    def test_no_match_unrelated_text(self):
        ...
        matched, confidence = match_team_in_text("Weather forecast for tomorrow", "Galatasaray")
...
class TestRelevanceScoring:
    ...
    def test_injury_topic_high_relevance(self):
        ...
        score = calculate_relevance_score(tweet_topics=["injury"], tweet_content="Player X injured")
    ...
    def test_lineup_topic_high_relevance(self):
        ...
        score = calculate_relevance_score(
            tweet_topics=["lineup", "squad"], tweet_content="Starting XI confirmed"
        )
    ...
    def test_transfer_topic_medium_relevance(self):
        ...
        score = calculate_relevance_score(
            tweet_topics=["transfer"], tweet_content="New signing announced"
        )
    ...
    def test_general_topic_base_relevance(self):
        ...
        score = calculate_relevance_score(tweet_topics=["general"], tweet_content="Match preview")
    ...
    def test_empty_topics_no_crash(self):
        ...
        score = calculate_relevance_score(tweet_topics=[], tweet_content="Some content")
    ...
    def test_none_topics_no_crash(self):
        ...
        score = calculate_relevance_score(tweet_topics=None, tweet_content="Some content")
    ...
    def test_injury_keyword_in_content(self):
        ...
        score = calculate_relevance_score(
            tweet_topics=[], tweet_content="Player ruled out with injury"
        )
...
class TestConflictDetection:
    ...
    def test_no_conflict_when_fotmob_none(self):
        ...
        from src.services.tweet_relevance_filter import ScoredTweet, detect_conflicts
...
class TestFilterTweetsForMatch:
    ...
    def test_filter_returns_result_structure(self):
        ...
        from src.services.tweet_relevance_filter import TweetFilterResult, filter_tweets_for_match

        result = filter_tweets_for_match(
            home_team="Galatasaray", away_team="Fenerbahce", league_key="soccer_turkey_super_league"
        )
    ...
    def test_filter_empty_cache_no_crash(self):
        ...
        result = filter_tweets_for_match(
            home_team="Unknown Team", away_team="Another Unknown", league_key="unknown_league"
        )
    ...
    def test_filter_none_teams_no_crash(self):
        ...
        result = filter_tweets_for_match(home_team=None, away_team=None, league_key=None)
...
class TestFormatForAI:
    ...
    def test_format_empty_tweets(self):
        ...
        result = format_tweets_for_ai(
            tweets=[], has_conflicts=False, conflict_desc=None, total_relevant=0
        )
    ...
    def test_format_includes_freshness_tag(self):
        ...
        from src.services.tweet_relevance_filter import ScoredTweet, format_tweets_for_ai
        ...
        result = format_tweets_for_ai(
            tweets=[mock_tweet], has_conflicts=False, conflict_desc=None, total_relevant=1
        )
...
class TestEdgeCases:
    ...
    def test_unicode_team_names(self):
        ...
        matched, conf = match_team_in_text("Fenerbahçe news update", "Fenerbahçe")
...
class TestGeminiConflictResolution:
    ...
    def test_format_gemini_resolution_denied(self):
        ...
        resolution = {"verification_status": "DENIED", "confidence_level": "MEDIUM"}

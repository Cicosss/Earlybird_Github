...
def test_odds_taken_market_coverage():
    ...
    snippet_data = {"current_home_odd": 1.65, "current_away_odd": 4.50, "current_draw_odd": 3.80}
...
def test_odds_taken_none_handling():
    ...
    snippet_data = {"current_home_odd": None, "current_away_odd": None, "current_draw_odd": None}

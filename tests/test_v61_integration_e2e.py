...
class TestE2EOptimizerFlow:
    ...
    def test_full_bot_cycle_with_v61_fixes(self):
        ...
        try:
            ...
            weight_bundesliga, _ = optimizer.get_weight(
                league="soccer_germany_bundesliga", market="Over 2.5"
            )
            ...
            combined_weight, _ = optimizer.get_weight(
                league="soccer_italy_serie_a", market="Over 2.5", driver="MATH_VALUE"
            )
    ...
    def test_settlement_flow_updates_weights_correctly(self):
        ...
        try:
            ...
            for driver, stats in optimizer.data["drivers"].items():
                assert stats["weight"] == 1.0, f"Driver {driver} should be FROZEN with weight=1.0"
    ...
    def test_edge_cases_in_production_flow(self):
        ...
        """
        from src.analysis.optimizer import StrategyOptimizer, categorize_market
    ...
    def test_persistence_and_recovery(self):
        ...
        try:
            ...
            assert "soccer_italy_serie_a" in optimizer2.data["stats"], "League stats should persist"
            assert "MATH_VALUE" in optimizer2.data["drivers"], "Driver stats should persist"
...
class TestMainPyIntegration:
    ...
    def test_imports_work(self):
        ...
        from src.analysis.optimizer import get_dynamic_alert_threshold, get_optimizer

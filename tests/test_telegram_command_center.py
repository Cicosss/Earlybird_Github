...
class TestStatsDrawer:
    ...
    def test_get_stats_data_handles_missing_file(self):
        ...
        from src.analysis.stats_drawer import OPTIMIZER_WEIGHTS_FILE, get_stats_data
    ...
    def test_draw_dashboard_creates_file(self):
        ...
        from src.analysis.stats_drawer import STATS_IMAGE_PATH, draw_dashboard
...
class TestSettler:
    ...
    def test_evaluate_bet_corners(self):
        ...
        from src.analysis.settler import RESULT_LOSS, RESULT_PENDING, RESULT_WIN, evaluate_bet

        # Over 9.5 corners with 11 total
        result, _ = evaluate_bet(
            "Over 9.5 Corners", 0, 0, match_stats={"home_corners": 6, "away_corners": 5}
        )
        assert result == RESULT_WIN

        # Over 9.5 corners with 8 total
        result, _ = evaluate_bet(
            "Over 9.5 Corners", 0, 0, match_stats={"home_corners": 4, "away_corners": 4}
        )
        assert result == RESULT_LOSS
...
class TestIsAdmin:
    ...
    def test_is_admin_with_matching_id(self):
        ...
        from src.entrypoints.run_bot import is_admin

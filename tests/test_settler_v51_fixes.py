...
class TestEvaluateOverUnderRegex:
    ...
    def test_over_9_5_corners_win(self):
        ...
        from src.analysis.settler import RESULT_WIN, evaluate_over_under
    ...
    def test_over_9_5_corners_loss(self):
        ...
        from src.analysis.settler import RESULT_LOSS, evaluate_over_under
    ...
    def test_integer_limit_supported(self):
        ...
        from src.analysis.settler import RESULT_LOSS, RESULT_WIN, evaluate_over_under
...
class TestEvaluateBetMatchStatsValidation:
    ...
    def test_corners_with_string_values(self):
        ...
        match_stats = {"home_corners": "invalid", "away_corners": "5"}

        result, explanation = evaluate_bet(
            "Over 9.5 Corners", home_score=2, away_score=1, match_stats=match_stats
        )
    ...
    def test_corners_with_negative_values(self):
        ...
        match_stats = {"home_corners": -5, "away_corners": 3}
    ...
    def test_cards_with_none_values_uses_default(self):
        ...
        # Total = 3 + 2 + 0 + 0 = 5
        result, explanation = evaluate_bet(
            "Over 4.5 Cards", home_score=2, away_score=1, match_stats=match_stats
        )
    ...
    def test_cards_with_string_values_uses_default(self):
        ...
        from src.analysis.settler import RESULT_LOSS, evaluate_bet

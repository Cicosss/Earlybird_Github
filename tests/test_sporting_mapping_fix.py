...
def test_sporting_clube_de_portugal_mapping():
    ...
    if "Sporting Clube de Portugal" in provider.MANUAL_MAPPING:
        ...
        print("✅ Mapping is correct: 'Sporting Clube de Portugal' → 'Sporting CP'")
    else:
        print("❌ MANUAL_MAPPING does not contain 'Sporting Clube de Portugal'")
        print("   Available mappings with 'Sporting':")
    ...
    if "Sporting CP" in provider.MANUAL_MAPPING:
        ...
        assert mapped_name == "Sporting CP", f"Expected 'Sporting CP', got '{mapped_name}'"
        print("✅ Identity mapping is correct: 'Sporting CP' → 'Sporting CP'")
    else:
        print("❌ MANUAL_MAPPING does not contain 'Sporting CP'")
        return False
    ...
    try:
        ...
        if team_id:
            print("✅ Team resolved successfully!")
            ...
            print("❌ Team resolution failed: returned None, None")
            print("   This might be due to:")
            print("   1. FotMob API not accessible (network issue)")
            print("   2. FotMob API rate limiting")
            print("   3. 'Sporting CP' not found in FotMob database")
            print("   Note: The MANUAL_MAPPING is correct, but the API call failed")

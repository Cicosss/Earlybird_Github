...
class TestSmartCacheTTLCalculation:
    ...
    def test_ttl_none_match_time_uses_default(self):
        ...
        from src.utils.smart_cache import DEFAULT_TTL_SECONDS, SmartCache
...
class TestSmartCacheExpiration:
    ...
    def test_is_expired_method(self):
        ...
        # Not expired
        entry = CacheEntry(data="test", created_at=time.time(), ttl_seconds=3600)
...
class TestSmartCacheIntegration:
    ...
    def test_global_caches_exist(self):
        ...
        from src.utils.smart_cache import get_match_cache, get_search_cache, get_team_cache

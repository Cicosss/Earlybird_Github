...
class TestThreadSafeAIStats:
    ...
    def test_reset_ai_response_stats_thread_safe(self):
        ...
        from src.analysis.analyzer import get_ai_response_stats, reset_ai_response_stats
...
class TestNewsSnippetMaxChars:
    ...
    def test_no_hardcoded_3000_in_analyzer(self):
        ...
        assert "NEWS_SNIPPET_MAX_CHARS" in content, "Should use NEWS_SNIPPET_MAX_CHARS constant"
...
class TestValidateAIResponseEdgeCases:
    ...
    def test_none_values(self):
        ...
        result = validate_ai_response(
            {"final_verdict": None, "confidence": None, "reasoning": None}
        )
    ...
    def test_extra_fields_preserved(self):
        ...
        result = validate_ai_response(
            {"final_verdict": "BET", "custom_field": "custom_value", "another_field": 123}
        )
...
class TestDeepDiveFallbackLogging:
    ...
    def test_intelligence_router_logging_exists(self):
        ...
        assert "Intelligence Router not available" in content or "deep_dive skipped" in content, (

...
class TestFreshnessModule:
    ...
    def test_full_freshness_result(self):
        ...
        from src.utils.freshness import FreshnessResult, get_full_freshness
...
class TestDiscoveryQueue:
    ...
    def test_push_and_pop(self):
        ...
        results = queue.pop_for_match(
            match_id="match123", team_names=["Arsenal", "Chelsea"], league_key="soccer_epl"
        )
    ...
    def test_pop_no_match(self):
        ...
        # Different team
        results = queue.pop_for_match(
            match_id="match123", team_names=["Liverpool"], league_key="soccer_epl"
        )
    ...
    def test_pop_different_league(self):
        ...
        # Different league
        results = queue.pop_for_match(
            match_id="match123", team_names=["Arsenal"], league_key="soccer_spain_la_liga"
        )
    ...
    def test_empty_team_names(self):
        ...
        # Empty team names
        results = queue.pop_for_match(match_id="match123", team_names=[], league_key="soccer_epl")
    ...
    def test_none_team_in_list(self):
        ...
        results = queue.pop_for_match(
            match_id="match123", team_names=[None, "Arsenal", ""], league_key="soccer_epl"
        )
    ...
    def test_thread_safety(self):
        ...
        def consumer():
            try:
                for _ in range(50):
                    queue.pop_for_match(
                        match_id="match", team_names=["Team0", "Team1"], league_key="soccer_epl"
                    )
                    time.sleep(0.001)
            except Exception as e:
                errors.append(e)
...
class TestIntegration:
    ...
    def test_freshness_in_discovery_queue(self):
        ...
        # Push discovery
        queue.push(data={}, league_key="soccer_epl", team="Arsenal", title="Breaking News")

        # Pop and check freshness tag
        results = queue.pop_for_match(
            match_id="match123", team_names=["Arsenal"], league_key="soccer_epl"
        )
...
class TestRegressions:
    ...
    def test_discovery_queue_returns_core_fields(self):
        ...
        results = queue.pop_for_match(
            match_id="match_456", team_names=["Manchester United"], league_key="soccer_epl"
        )
    ...
    def test_get_browser_monitor_news_no_duplicate_return(self):
        ...
        results = get_browser_monitor_news(
            match_id="test_match", team_names=["Test Team"], league_key="non_existent_league_xyz"
        )
